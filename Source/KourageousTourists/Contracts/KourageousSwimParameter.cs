...
{
	public class KourageousSwimParameter: KourageousParameter 
	{
		public KourageousSwimParameter() : base() {}

		public KourageousSwimParameter(CelestialBody target, String kerbal) : base(target, kerbal) {}

		protected override string GetHashString() {
			return "swim" + this.targetBody.bodyName + this.tourist;
		}
